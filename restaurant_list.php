...
<?php
	...
	if (isset($_GET['search_text'])) {
		...
		$restaurant_select_query = "SELECT * FROM restaurants WHERE restaurant_name LIKE '%$search_text%'";

		$selected_restaurant = mysqli_query($connection, $restaurant_select_query);
	} else {

		$restaurant_select_query = "SELECT * FROM restaurants WHERE 1";
		...
		<div class="col l4 m4">
						...
						<div class="card">
						    <div class="card-image waves-effect waves-block waves-light">
						      <img class="activator" src="images/restaurants/<?php echo $restaurant['restaurant_pic']; ?>">
						    </div>
						    <div class="card-content">
						      <span class="card-title activator grey-text text-darken-4"><?php echo $restaurant['restaurant_name']; ?><i class="material-icons right">more_vert</i></span>
						      <p>
						      	
									<?php

										if ($restaurant['city'] == "dha") {
																	
											echo "Dhaka";
										}else if ($restaurant['city'] == "chi") {

											echo "Chittagong";
										}else if ($restaurant['city'] == "syl") {

											echo "Sylhet";
										}else if ($restaurant['city'] == "bar") {

											echo "Barisal";
										}else if ($restaurant['city'] == "raj") {

											echo "Rajshahi";
										}else if ($restaurant['city'] == "ran") {
						    ...
						    <div class="card-reveal">
						      <span class="card-title grey-text text-darken-4">Menues<i class="material-icons right">close</i></span>
			...
			<?php
				...
				if (!$restaurant = mysqli_fetch_assoc($selected_restaurant)) {
