...
<?php
	...
	if (isset($_GET['search_text'])) {
		...
		$menu_select_query = "SELECT * FROM menues WHERE menu_name LIKE '%$search_text%' ORDER BY average_rating DESC";

		$selected_menu = mysqli_query($connection, $menu_select_query);
	} else {

		$menu_select_query = "SELECT * FROM menues WHERE 1 ORDER BY average_rating DESC";
		...
		<div class="col l4 m4">
						...
						<div class="card">
						    <div class="card-image waves-effect waves-block waves-light">
						      <img class="activator" src="images/menues/<?php echo $menu['menu_pic']; ?>">
						    </div>
						    <div class="card-content">
						      <span class="card-title activator grey-text text-darken-4"><?php echo $menu['menu_name']; ?><i class="material-icons right">more_vert</i></span>
						      <p>
						    ...
						    <div class="card-reveal">
						      <span class="card-title grey-text text-darken-4">Rating<i class="material-icons right">close</i></span>

						      <div style="font-size: 5vw; color:  #ff7c1a; margin-top: 100px; width: 100%; text-align: center;" >
			...
			<?php
				...
				if (!$menu = mysqli_fetch_assoc($selected_menu)) {
